package com.cilicili.cilicili.utils;
...
import com.cilicili.cilicili.AppContext;
import com.cilicili.cilicili.net.Logger;
...
//        Log.d("OSUtil", "get property, " + key + " = " + value);
    ...
    public static PackageInfo getPackageInfo(String pckName) {
        try {
            return AppContext.getInstance().getPackageManager()
                    .getPackageInfo(pckName, 0);
        } catch (PackageManager.NameNotFoundException e) {
            Logger.e(e.getMessage());
        }
    ...
    public static String getIMEI() {
        String reslut="";
        try {
            TelephonyManager tel = (TelephonyManager) AppContext.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
            if(tel!=null){
    ...
    public static String getIMEIEncode() {
        String reslut="";
        try {
            TelephonyManager tel = (TelephonyManager) AppContext.getInstance()
...
//    }
    ...
    public static String getSimSerialNumber() {
        TelephonyManager tm = (TelephonyManager) AppContext.getInstance().getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getAppName() {
        ...
        try {
            info = manager.getPackageInfo(AppContext.getInstance().getPackageName(), 0);
    ...
    public static String getOperatorType() {
        ...
        TelephonyManager phoneManager = (TelephonyManager)AppContext.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getResolution() {
        ...
        DisplayMetrics display = AppContext.getInstance().getResources()
                .getDisplayMetrics();
