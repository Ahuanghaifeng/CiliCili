...
public final class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(AppContext.getInstance().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(AppContext.getInstance().getResources().getString(resId), args), duration);
    }
